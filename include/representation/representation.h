...
public:
  ...
  // explicit RoomNodeRep(const tare_planner::RoomNode msg);
  RoomNodeRep() = default;
  ~RoomNodeRep() = default;
  ...
  void UpdateRoomNode(const tare_planner::RoomNode msg);
...
{
public:
  explicit ObjectNodeRep(const tare_planner::ObjectNode::ConstPtr msg);
  ...
  void UpdateObjectNode(const tare_planner::ObjectNode::ConstPtr msg);
...
public:
   ...
   */
  RoomNodeRep& AddRoomNode(const tare_planner::RoomNode& msg);
