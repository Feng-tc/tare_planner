...
void PublishCloud(ros::NodeHandle* node, ros::Publisher& cloud_publisher,
...
void Publish(ros::NodeHandle* /*node*/, ros::Publisher& publisher, ROSMsgType& msg,
...
public:
  ...
  {
    marker_pub_ = nh_->advertise<visualization_msgs::Marker>(pub_topic_, 2);
    id_++;
    marker_.id = id_;
