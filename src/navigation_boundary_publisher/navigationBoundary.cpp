...
int main(int argc, char** argv)
{
  ...
  pnh.param<std::string>("boundary_file_dir", boundary_file_dir, "");
  pnh.param("sendBoundary", sendBoundary, false);
  pnh.param("sendBoundaryInterval", sendBoundaryInterval, 2);
