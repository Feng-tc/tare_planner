...
namespace representation_ns {
    ...
    void RoomNodeRep::UpdateRoomNode(const tare_planner::RoomNode msg)
    {
        id_ = msg.id;
    ...
    ObjectNodeRep::ObjectNodeRep(const tare_planner::ObjectNode::ConstPtr msg)
    : room_id_(-1)
    {
    ...
    void ObjectNodeRep::UpdateObjectNode(const tare_planner::ObjectNode::ConstPtr msg)
    {
        object_id_ = msg->object_id; 
        label_ = msg->label;
        position_ = msg->position;
    ...
    void Representation::UpdateObjectNode(const tare_planner::ObjectNode::ConstPtr msg)
    {
    ...
    RoomNodeRep& Representation::AddRoomNode(const tare_planner::RoomNode& msg)
    {
