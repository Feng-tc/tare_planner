...
{
  double pointcloud_cell_size = ([&](){ double _v=0.0; nh->param("kPointCloudCellSize", _v, _v); return _v; }());
  double pointcloud_cell_height = ([&](){ double _v=0.0; nh->param("kPointCloudCellHeight", _v, _v); return _v; }());
  int pointcloud_cell_neighbor_number = ([&](){ int _v=0; nh->param("kPointCloudManagerNeighborCellNum", _v, _v); return _v; }());
  ...
  resolution_.x() = ([&](){ double _v=0.0; nh->param("rolling_occupancy_grid/resolution_x", _v, _v); return _v; }());
  resolution_.y() = ([&](){ double _v=0.0; nh->param("rolling_occupancy_grid/resolution_y", _v, _v); return _v; }());
  resolution_.z() = ([&](){ double _v=0.0; nh->param("rolling_occupancy_grid/resolution_z", _v, _v); return _v; }());
  ...
  sensor_range = ([&](){ double _v=0.0; nh->param("kRepSensorRange", _v, _v); return _v; }());
  // calculate the sensor range in grid size
  sensor_range_in_sub = ((sensor_range) / resolution_.x()) * ((sensor_range) / resolution_.x());

  ray_voxel_pub_ = nh->advertise<visualization_msgs::Marker>(
      "ray_voxels",
      1);
    ...
    float r, float g, float b, float a)
{
  ...
  mk.lifetime = ros::Duration(0); // persistent until overwritten
