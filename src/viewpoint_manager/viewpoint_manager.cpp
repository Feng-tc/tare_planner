...
{
  nh->param("kUseFrontier", kUseFrontier, kUseFrontier);
  kNumber.x() = ([&](){ int _v=0; nh->param("viewpoint_manager/number_x", _v, _v); return _v; }());
  kNumber.y() = ([&](){ int _v=0; nh->param("viewpoint_manager/number_y", _v, _v); return _v; }());
  kNumber.z() = ([&](){ int _v=0; nh->param("viewpoint_manager/number_z", _v, _v); return _v; }());
  kResolution.x() = ([&](){ double _v=0.0; nh->param("viewpoint_manager/resolution_x", _v, _v); return _v; }());
  kResolution.y() = ([&](){ double _v=0.0; nh->param("viewpoint_manager/resolution_y", _v, _v); return _v; }());
  kResolution.z() = ([&](){ double _v=0.0; nh->param("viewpoint_manager/resolution_z", _v, _v); return _v; }());
  ...
  nh->param("kConnectivityHeightDiffThr", kConnectivityHeightDiffThr, kConnectivityHeightDiffThr);
  nh->param("kViewPointCollisionMargin", kViewPointCollisionMargin, kViewPointCollisionMargin);
  nh->param("kViewPointCollisionMarginZPlus", kViewPointCollisionMarginZPlus, kViewPointCollisionMarginZPlus);
  nh->param("kViewPointCollisionMarginZMinus", kViewPointCollisionMarginZMinus, kViewPointCollisionMarginZMinus);
  nh->param("kCollisionGridZScale", kCollisionGridZScale, kCollisionGridZScale);
  kCollisionGridResolution.x() = ([&](){ double _v=0.0; nh->param("kCollisionGridResolutionX", _v, _v); return _v; }());
  kCollisionGridResolution.y() = ([&](){ double _v=0.0; nh->param("kCollisionGridResolutionY", _v, _v); return _v; }());
  kCollisionGridResolution.z() = ([&](){ double _v=0.0; nh->param("kCollisionGridResolutionZ", _v, _v); return _v; }());
  nh->param("kLineOfSightStopAtNearestObstacle", kLineOfSightStopAtNearestObstacle, kLineOfSightStopAtNearestObstacle);
  nh->param("kCheckDynamicObstacleCollision", kCheckDynamicObstacleCollision, kCheckDynamicObstacleCollision);
  nh->param("kCollisionFrameCountMax", kCollisionFrameCountMax, kCollisionFrameCountMax);
  nh->param("kViewPointHeightFromTerrain", kViewPointHeightFromTerrain, kViewPointHeightFromTerrain);
  nh->param("kViewPointHeightFromTerrainChangeThreshold", kViewPointHeightFromTerrainChangeThreshold, kViewPointHeightFromTerrainChangeThreshold);
  nh->param("kCollisionPointThr", kCollisionPointThr, kCollisionPointThr);
  nh->param("kCoverageOcclusionThr", kCoverageOcclusionThr, kCoverageOcclusionThr);
  nh->param("kCoverageDilationRadius", kCoverageDilationRadius, kCoverageDilationRadius);
  nh->param("kCoveragePointCloudResolution", kCoveragePointCloudResolution, kCoveragePointCloudResolution);
  nh->param("kSensorRange", kSensorRange, kSensorRange);
  nh->param("kNeighborRange", kNeighborRange, kNeighborRange);
...
{ 
  ...
  for (int i = 0; i < vp_.kViewPointNumber; i++)
  {
    ...
    {
      // ROS_INFO(//              "Viewpoint %d with room id %d is in room %d",
